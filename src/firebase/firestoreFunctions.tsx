import { 
  ...
  import { type InspectionSchedule, type InspectionReport, type ViolationResult } from '../types/schedule';
   ...
   */
  export const getLicensesByBusinessId = async (businessId: string): Promise<License[]> => {
    try {
      const querySnapshot = await getDocs(collection(db, 'businesses', businessId, 'licenses'));
   ...
   */
  export const getEmployeesByBusinessId = async (businessId: string): Promise<Worker[]> => {
    try {
      const querySnapshot = await getDocs(collection(db, 'businesses', businessId, 'employees'));
   ...
   */
  export const getInspectionsByBusinessId = async (businessId: string): Promise<InspectionSchedule[]> => {
    try {
      const querySnapshot = await getDocs(collection(db, 'businesses', businessId, 'inspections'));
   ...
   */
  export const getReportsByInspectionId = async (businessId: string, inspectionId: string): Promise<InspectionReport[]> => {
    try {
      const querySnapshot = await getDocs(collection(db, 'businesses', businessId, 'inspections', inspectionId, 'reports'));
   ...
   */
  export const getViolationsByReportId = async (businessId: string, inspectionId: string, reportId: string): Promise<ViolationResult[]> => {
    try {
      const querySnapshot = await getDocs(collection(db, 'businesses', businessId, 'inspections', inspectionId, 'reports', reportId, 'violations'));
   ...
   */
  export const subscribeToBusiness = (businessId: string, callback: (business: Business | null) => void) => {
    const docRef = doc(db, 'businesses', businessId);
   ...
   */
  export const subscribeToLicenses = (businessId: string, callback: (licenses: License[]) => void) => {
   ...
   */
  export const subscribeToEmployees = (businessId: string, callback: (employees: Worker[]) => void) => {
   ...
   */
  export const subscribeToInspections = (businessId: string, callback: (inspections: InspectionSchedule[]) => void) => {
